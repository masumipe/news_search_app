...
def search():
    ...
    results = service.search(
        ...
        domains=domains,
        page=page,
        prioritize_country=True,
        user_countries=user_countries if user_countries else None,
    )

    if current_app.recommender._fitted and user_countries:
    ...
    return render_template(
        ...
        query=topic,
        country=country,
        popular_countries=service.POPULAR_COUNTRIES,
    )
