...
class UserPreference(db.Model):
    ...
    def get_countries(self):
        return [c.strip() for c in self.preferred_countries.split(",") if c.strip()]

    def get_news_sources(self):
        import json
        val = self.news_sources
        if not val:
            return []
        try:
    ...
    def to_dict(self):
        return {
            ...
            "preferred_countries": self.get_countries(),
