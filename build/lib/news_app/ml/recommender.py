...
class RecommenderService:
    ...
    def fit(self, articles: Optional[list] = None):
        ...
        self._article_ids = []
        for a in articles:
            text = f"{a.title} {a.description or ''} {a.tags or ''} {a.region or ''}"
            texts.append(text)
    ...
    def _build_user_profile(self, user_id: int) -> Optional[str]:
        ...
        regions = pref.get_regions() if pref else []
        ...
        profile_parts = list(topics) + list(regions)
    ...
    def _explain_recommendation(self, article: Article, profile: str, user_id: int) -> list:
        ...
        if article.region and user_regions and article.region in user_regions:
            reasons.append(f"From your preferred region: {article.region}")
    ...
    def rank_search_results(self, user_id: int, articles: list) -> list:
        ...
        for article in articles:
            ...
            if article.get("region") in user_regions:
                score += 0.4
